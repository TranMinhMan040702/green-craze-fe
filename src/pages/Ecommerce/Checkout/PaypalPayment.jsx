            ...
            {orderApi?.data?.data?.transaction?.paymentMethod.toLowerCase().includes('paypal') ? (
                !orderApi?.data?.data?.paymentStatus ? (
                    ...
                    <Alert
                        ...
                        message={<h1 className='font-bold text-green-600'>Thanh toán thành công</h1>}
                        description={<p className='text-[2rem]'>Đơn hàng đã được thanh toán trước đó</p>}
                        type="success"
                    />
                )
            ) : (
                <Alert
                    ...
                    description={<p className='text-[2rem]'>Đơn hàng này không cần thanh toán trước</p>}
                    type="error"
                />
            )}
        </div>
