...
function Head({ code, status }) {
    return (
        <div className="flex justify-between p-[2rem] border-b-[0.1rem]">
            <NavLink
                to={config.routes.web.order}
                className="flex items-center gap-[0.3rem] text-[1.6rem] cursor-pointer hover:text-red-300 transition-all"
            >
            ...
            <div className="flex items-center text-[1.4rem]">
                <p className="uppercase">
                    Mã đơn hàng <p className="font-bold text-green-800">{code}</p>
                </p>
