...
function PriceVariant() {
    ...
    return (
        <div className="price-variant">
            <Radio.Group className="flex items-center" onChange={onChange} value={value}>
                <Radio
                    className="element w-[190px] h-[106px] p-[8px] flex flex-col items-center"
                    value={1}
                >
                    <div className="flex flex-col items-center">
                        <span className="text-[1.2rem]">Lốc - 25 cái</span>
                        <span className="price text-[1.9rem] font-medium price-color">
                            187.500đ
                        </span>
                        <span className="text-[1.2rem] opacity-[0.8]">{`(7.500đ/cái)`}</span>
                        <svg
